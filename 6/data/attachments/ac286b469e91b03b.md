...
- Name: dashboard/dashboard-header.spec.ts >> Dashboard Module - Header >> CRM_DASHBOARD_TC_012 - Click icon Timers mở dropdown đúng nội dung
- Location: src/tests/dashboard/dashboard-header.spec.ts:74:7
...
Locator:  locator('#started-timers-top')
Expected: visible
Received: hidden
Timeout:  10000ms
...
Call log:
  ...
  - waiting for locator('#started-timers-top')
    22 × locator resolved to <ul id="started-timers-top" class="dropdown-menu animated fadeIn started-timers-top width300">…</ul>
